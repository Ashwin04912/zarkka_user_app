...
import 'application/orders/bloc/orders_bloc.dart' as _i197;
...
import 'infrastructure/FACADES/i_orders_facade.dart' as _i940;
...
import 'infrastructure/orders/upcomming_order_api_impl.dart' as _i926;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.factory<_i197.OrdersBloc>(() => _i197.OrdersBloc());
    ...
    gh.lazySingleton<_i940.IOrdersFacade>(() => _i926.OrderApiImpl());
    return this;
  }
}
